    ...
    */
    ...
    'settings' => [
        ...
        */
        ...
        'HTML.Allowed' => 'b,strong,i,em,a[href|title],ul,ol,li,p[style],br,span[style],pre,img[width|height|alt|src]',
        ...
        */
        ...
        'CSS.AllowedProperties' => 'h1,h2,h3,h4,h5,a[href|title],font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,color,background-color,text-align',
